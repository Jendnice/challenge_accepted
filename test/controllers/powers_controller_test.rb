...
class PowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create power" do
    assert_difference('Power.count') do
      post powers_url, params: { power: { description: @power.description, info: @power.info, name: @power.name } }, as: :json
    end
  ...
  test "should update power" do
    patch power_url(@power), params: { power: { description: @power.description, info: @power.info, name: @power.name } }, as: :json
    assert_response 200
  end
